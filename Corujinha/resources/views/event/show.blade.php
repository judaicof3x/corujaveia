            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                ...
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="/storage/{{ $event->event_photo_path }}" alt="image">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $event->name }}</a>
                                <a href="#">
                    ...
                    <div class="d-flex flex-wrap flex-stack">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--end::Svg Icon-->
                                        <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="4500">5</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Galerias</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                                <!--begin::Stat-->
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Fotos</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                                <!--begin::Stat-->
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--end::Svg Icon-->
                                        <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="60">60</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Likes</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                            </div>
                        ...
                        <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                <span class="fw-bold fs-6 text-gray-400">Popularidade</span>
                ...
                <div class="card overlay overflow-hidden">
                    <div class="card-body p-0">
                        <div class="overlay-wrapper">
                            <img src="/storage/{{ $event->event_photo_path }}" alt="" class="w-100 rounded"/>
                        </div>
                        <div class="overlay-layer bg-dark bg-opacity-25">
                            <a href="{{ route('event.show', $event->slug) }}" class="btn btn-dark btn-shadow col-8">Explorar</a>
                        </div>
                    </div>
